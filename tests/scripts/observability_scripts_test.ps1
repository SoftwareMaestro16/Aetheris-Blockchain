...
$nodeHome = Join-Path $OutputDir "node0\orbitalisd"
...
'{"genesis_time":"2026-06-04T00:00:00Z","chain_id":"orbitalis-test"}' | Set-Content -LiteralPath (Join-Path $configDir "genesis.json")
@'
[api]
enable = false
