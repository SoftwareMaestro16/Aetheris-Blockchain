...
var (
	pattern_Query_Pool_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"l1", "dex", "v1", "pools", "pool_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Pools_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"l1", "dex", "v1", "pools"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_PoolByPair_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"l1", "dex", "v1", "pool_by_pair"}, "", runtime.AssumeColonVerbOpt(false)))
)
