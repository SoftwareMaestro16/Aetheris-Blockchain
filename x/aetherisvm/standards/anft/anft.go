...
func DeriveItemAddress(collection sdk.AccAddress, index uint64, itemCodeHash []byte) (sdk.AccAddress, error) {
	if err := aetherisaddress.RejectZeroAddress("nft collection", collection); err != nil {
		return nil, err
	}
...
func (c CollectionState) Validate() error {
	if err := aetherisaddress.RejectZeroAddress("nft collection", c.Address); err != nil {
		return err
	}
	if err := aetherisaddress.RejectZeroAddress("collection admin", c.Admin); err != nil {
		return err
	}
...
func (i ItemState) Validate() error {
	if err := aetherisaddress.RejectZeroAddress("nft item", i.Address); err != nil {
		return err
	}
	if err := aetherisaddress.RejectZeroAddress("nft collection", i.CollectionAddress); err != nil {
		return err
	}
	if err := aetherisaddress.RejectZeroAddress("item owner", i.Owner); err != nil {
		return err
	}
	if !i.Initialized {
	...
	if i.Kind == ItemKindSBT {
		...
		if err := aetherisaddress.RejectZeroAddress("SBT immutable owner", i.ImmutableOwner); err != nil {
			return err
		}
		if err := aetherisaddress.RejectZeroAddress("SBT authority", i.Authority); err != nil {
			return err
		}
...
func (s *State) MintSBT(caller, owner, authority sdk.AccAddress, metadata Metadata) (ItemState, error) {
	if err := aetherisaddress.RejectZeroAddress("SBT authority", authority); err != nil {
...
func (s *State) TransferNFT(caller sdk.AccAddress, itemAddress sdk.AccAddress, newOwner sdk.AccAddress) error {
	...
	if err := aetherisaddress.RejectZeroAddress("new item owner", newOwner); err != nil {
		return err
	}
...
func (s *State) ChangeAdmin(caller, newAdmin sdk.AccAddress) error {
	...
	if err := aetherisaddress.RejectZeroAddress("new collection admin", newAdmin); err != nil {
		return err
	}
...
func (s *State) mint(caller, owner, authority sdk.AccAddress, metadata Metadata, kind ItemKind) (ItemState, error) {
	...
	if err := aetherisaddress.RejectZeroAddress("item owner", owner); err != nil {
		return ItemState{}, err
	}
	if err := ValidateMetadata(metadata); err != nil {
		return ItemState{}, err
...
func (s *State) requireItem(address sdk.AccAddress) (ItemState, error) {
	if err := aetherisaddress.RejectZeroAddress("nft item", address); err != nil {
		return ItemState{}, err
	}
